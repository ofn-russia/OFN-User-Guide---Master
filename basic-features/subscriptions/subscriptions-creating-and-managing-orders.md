...
На этой странице описывается, как магазины могут настраивать уникальные подписки для отдельных клиентов, в том числе, какие товары включены в их подписку, к какому [расписани](subscriptions-configuration.md#schedules)ю применяется подписка \(т.е. скорось, с которой они получают свой заказ\) и как приостановить/именить свою подписку.
